                        ...
                        <nav className="hidden md:flex space-x-3">
                            {navLink.map((link) => (
                                <Link key={link.path} to={link.path} className={
                                    ...
                                    : "text-gray-400 h-10 px-3 py-2 hover:text-green-200 hover:bg-primary-500/5 rounded-md"
                                }>
                                    {link.name}
                                </Link>
                            ))}
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        {isAuthenticated ?(
                            <div className="flex items-center space-x-4">
                                ...
                                className=" hover:text-red-500 hover:bg-red-600 p-2 rounded-full transition-colors cursor-pointer"
                                >
                        ...
                        <nav className="space-y-1">
                            {navLink.map((link)=>(
                                ...
                                className={`block p-5 rounded-lg ${
                                    ...
                                    : "text-gray-400 hover:bg-gray-800  hover:text-green-200"
                                }`}
