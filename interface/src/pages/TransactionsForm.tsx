...
const TransactionsForm = () => {
    ...
    const validateForm = (): boolean => {
        if (!formData.description || !formData.categoryId || !formData.amount || !formData.date) {
    ...
    const handleSubmit = async (event: FormEvent): Promise<void> => {
        ...
        try {
            ...
            toast.success("Transação adicionada com successo");
            navigate("/transacoes")
    ...
    return (
        <div className="container-app py-8">
            <div className="max-w-2xl mx-auto">
                <h1 className="text-2xl font-boldmb-6">Nova Transação</h1>
                <Card>

                    {error && (
                        <div className="flex items-center bg-transparent border border-red-700 rounded-xl p-4 mb-6 gap-2">
